...
# Generate histograms plot
hist_rounded <- ggplot(results, aes(x = p_values)) + geom_histogram(color="gray", fill="white", bins = 20, size = 1) + theme(text=element_text(size=14)) + scale_x_continuous(name = "p-value", breaks=c(0, 1)) + facet_wrap(.~histogram, scales = "free_y")
```
...
# Generate histograms plot
hist_correlation <- ggplot(ar_results, aes(x = p_value)) + geom_histogram(color="gray", fill="white", bins = 20, size = 1) + theme(text=element_text(size=14)) + scale_x_continuous(name = "p-value", breaks=c(0, 1)) + facet_wrap(.~ar, scales = "free_y", ncol = 3)
```
...
# Create the histograms displaying p-values from each test
test1 <- suppressWarnings(test_dgof(10000, 30, 3))
test2 <- suppressWarnings(test_dgof(10000, 30, 2))
test3 <- suppressWarnings(test_dgof(10000, 30, 1))
results <- rbind(test1, test2, test3)

# Generate histograms plot
hist_dgof <- ggplot(results, aes(x = p_values)) + geom_histogram(color="gray", fill="white", bins = 20) + geom_histogram(color="gray", fill="white", bins = 20, size = 1) + theme(text=element_text(size=14)) + scale_x_continuous(name = "p-value", breaks=c(0, 1)) + facet_wrap(.~test+digits, ncol = 3, scales = "free_y")
```
...
# Generate histograms plot
hist_dgofsim <- ggplot(results, aes(x = p_values)) + geom_histogram(color="gray", fill="white", bins = 20) + geom_histogram(color="gray", fill="white", bins = 20, size = 1) + theme(text=element_text(size=14)) + scale_x_continuous(name = "p-value", breaks=c(0, 1)) + facet_wrap(.~test+digits, scales = "free_y")
```
...
# Generate histograms plot
hist_parametric <- ggplot(results, aes(x = p_values)) + geom_histogram(color="gray", fill="white", bins = 20) + geom_histogram(color="gray", fill="white", bins = 20, size = 1) + theme(text=element_text(size=14)) + scale_x_continuous(name = "p-value", breaks=c(0, 1)) + facet_wrap(.~histogram, scales = "free_y")
...
```{r}
ggsave(filename="hist_normal.pdf", plot=hist_normal, path = "/Users/anthony/Desktop/School Work/Honors Thesis/KS-Test-Thesis/Manuscript")
ggsave(filename="hist_rounded.pdf", plot=hist_rounded, path = "/Users/anthony/Desktop/School Work/Honors Thesis/KS-Test-Thesis/Manuscript")
ggsave(filename="hist_correlation.pdf", plot=hist_correlation, path = "/Users/anthony/Desktop/School Work/Honors Thesis/KS-Test-Thesis/Manuscript")
ggsave(filename="hist_dgof.pdf", plot=hist_dgof, path = "/Users/anthony/Desktop/School Work/Honors Thesis/KS-Test-Thesis/Manuscript")
ggsave(filename="hist_dgofsim.pdf", plot=hist_dgofsim, path = "/Users/anthony/Desktop/School Work/Honors Thesis/KS-Test-Thesis/Manuscript")
ggsave(filename="hist_parametric.pdf", plot=hist_parametric, path = "/Users/anthony/Desktop/School Work/Honors Thesis/KS-Test-Thesis/Manuscript")
```