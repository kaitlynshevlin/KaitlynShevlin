...
test_block <- function(ar, B = 1000, l, n) {
...
# Generate results
pvals_block <- suppressWarnings(replicate(20, test_block(ar = 0.5, B = 1000, l = 5, n = 100)$p.value))
pvals_block
pvals_naive_block <- suppressWarnings(replicate(20, test_naive_block(ar = 0.5, n = 100)$p.value))

# Create a master data_frame with all the results
histogram <- c(rep("Block", 20), rep("Naive", 20))
