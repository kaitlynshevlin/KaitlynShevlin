...
has been "discovered" that the test loses its power when applied to dependent or 
discrete data with hypothesized distributions containing estimated parameters 
\citep{Steinskog}.

It is well known that the standard test does not apply for
discrete data. \citet{Noether} provides a brief demonstration of the 
